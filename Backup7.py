...
class attendance:
    ...
    def get_current_permission(self):
        ...
        GET(self.current_permission)
        self.times += 1

    def check_new_person(self):
        print "Check new Person..."
        GET(self.check_new_url)
        self.times += 1
    ...
    def get_all_attendance(self):
        ...
        POST(self.all_attendance, kernel)
        self.times += 1
    ...
    def post_leave(self):
        ...
        kernel = {"leaveState":"1","approvalId":self.my_id,"leaveEndTime":"2016-08-08",
                  "leaveStartTime":"2016-08-04","vacationTypeId":self.vacation_type_id[0],
                  "remark":"Robot Test","year":2016,"month":8,"machineType":2}
