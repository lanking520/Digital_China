...
Author: Qing Lan
Copyright: iQuicker
Description: This terminal test program is worked on around 100 terminals. It can generate the csv file.
'''
# -*- coding: gb18030 -*-
# -*- coding: utf-8 -*-
import cookielib
...
class attendance:
    ...
    def find_outwork(self):
        ...
        self.outwork_id = []
        template = [[[[u'approvalItcode', u'approvalName', u'approvalStateDesc', u'aprovalCommont', u'aprovalDate', u'aprovalId', u'aprovalResult', u'aprovalSate', u'createDate', u'creator', u'creatorItcode', u'creatorName', u'id', u'isNeedCreator', u'mobileBeatList', u'mobileBeats', u'org', u'outDate', u'outEndDate', u'outReason', u'outStartDate', u'outType', u'outTypeDesc', u'remark']], [[u'ascending', u'direction', u'ignoreCase', u'nullHandling', u'property']], [u'content', u'first', u'last', u'number', u'numberOfElements', u'size', u'sort', u'totalElements', u'totalPages']], [u'data', u'message', u'status', u'success']]
...
def store_to_csv():
    ...
    file_name = 'Terminal_test'+str(get_raw_time())+'.csv'
    csvfile = file(file_name, 'wb')
    csvfile.write(codecs.BOM_UTF8)
    writer = csv.writer(csvfile)
    writer.writerow(['Section','Name', 'URL', 'Success', 'Failure Reason'])
    kernel = ["", "", "", "", ""]
    for my_data in data_set:
        ...
        for line_data in my_data[section_name]:
            ...
            kernel[4] = line_data['Failure Reason']
