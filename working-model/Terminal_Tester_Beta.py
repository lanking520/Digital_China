'''
Name: Terminal Tester Program for iQuicker
Author: Qing Lan
Copyright: Personal
Description: This version works on 90% percent of terminals. Error happened in "Deleting Outwork" of Attendance Class.
             Two more helper functions added for sorting the String array structure. Any inquires Email to : lanking520@live.com
'''
# -*- coding: gb18030 -*-
# -*- coding: utf-8 -*-
import cookielib
...
class attendance:
    def __init__(self):
        ...
        self.function_name = {"login" : 1, "Get Personal info" : 2, "Get Current Permission" : 3, "Check new person" : 4,
                              ...
                              "Get Attendacne List" : 9, "Get others Attendance" : 10}
    ...
    def get_current_permission(self):
        ...
        self.determine_error(GET(self.current_permission), "Get Current Permission", [], self.current_permission)
        self.times += 1

    def check_new_person(self):
        print "Check new Person..."
        self.determine_error(GET(self.check_new_url),"Check new person", [], self.check_new_url)
        self.times += 1
    ...
    def get_all_attendance(self):
        ...
        self.determine_error(POST(self.all_attendance, kernel), "Get all Attendance", [], self.all_attendance)
        self.times += 1

    def get_personal_attendance(self):
        print "Get Personal Attendance..."
        self.determine_error(GET(self.att_info), "Get personal Attendance", [], self.att_info)
        self.times += 1
    ...
    def get_personal_leave(self):
        ...
        self.determine_error(data_fetcher, "Get Leave Id", [], self.personal_leave)
    ...
    def get_outwork(self):
        ...
        self.determine_error(GET(self.outwork_url), "Get Outwork Data", [], self.outwork_url)
        self.times += 1

    def get_att_list(self):
        print "Getting all Personal Attendance..."
        kernel = {"month" : 7, "personId" : self.my_id, "year": 2016}
        self.determine_error(GET(self.personal_att_url, kernel), "Get Attendacne List", [], self.personal_att_url)
        self.times += 1

    def get_spec_att(self):
        print "Get Specific Attendance..."
        kernel = {"personId" : self.my_id, "searchDate" : "2016-07-01"}
        self.determine_error(GET(self.spec_att_url, kernel), "Get Specific Attendance", [], self.spec_att_url)
        self.times += 1

    def get_other_att(self):
        print "get other people Attendance..."
        kernel = { "month" : 7, "page" : 1, "pageSize" : 8, "year" : 2016}
        self.determine_error(GET(self.other_att_url, kernel), "Get others Attendance", [], self.other_att_url)
        self.times += 1
    ...
    def find_last_attendance(self):
        ...
        GET(self.find_last_att_url, kernel)
        self.times += 1

    def find_by_leave_enable(self):
        print "Find By leave Enable Terminal..."
        kernel = {"month" : 7, "year" : 2016}
        GET(self.find_by_leave_url, kernel)
        self.times += 1
    ...
    def post_leave(self):
        ...
        POST(self.post_leave_url, kernel)
        self.times += 1
    ...
    def delete_leave_request(self):
        ...
        print POST(self.delete_leave_url, kernel)
        self.times += 1
    ...
    def get_person_Vacation_apply(self):
        print "Getting single pieve of vacation request..."
        self.select_person_vacation()
        kernel = {"leaveApplyId" : self.leaveApplyId[0]}
        GET(self.find_person_leave, kernel)
        self.times += 1
    ...
    def approve_person_vacation(self):
        ...
        print kernel
        print self.vacation_decision
        print POST(self.vacation_decision, kernel)
        self.times += 1
    ...
    def post_outwork(self):
        ...
        POST(self.outwork_post_url, kernel)
        self.times += 1
    ...
    def get_single_outwork(self):
        ...
        GET(self.outwork_single_url, kernel)
        self.times += 1
