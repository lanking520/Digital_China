...
License: MIT
Description: This version has switched its working environment into tests. GET method had modified to "json = False"
"""
import cookielib
import urllib2
import urllib
...
GET(all_news, all_news_data)
news_id = "https://testwww.iquicker.com.cn/iquicker_web/news/data/num"
GET(news_id)
news1 = "http://testwww.iquicker.com.cn/iquicker_web/news/data/43347355-d11e-4dd8-88c6-38efd8813826"
GET(news1)
for item in cj:
